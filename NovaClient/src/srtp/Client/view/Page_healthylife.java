...
public class Page_healthylife extends JPanel {
	...
	Page_detail page_1;
	Page_healthylife ptr;
	 String cardNo;
	public Page_healthylife() throws IOException {
		ptr=this;
		...
		booklabel_1.addMouseListener(new MouseAdapter() {
			...
			//	page_1 =new Page_detail(vecClassOne.get(0).getBook_id(),null);
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					setLabelBac("" + tempVector.get(randomInt).getBook_id(),
							booklabel_1);
					randomInt++;
					randomInt %= tempSize;
					setLabelBac("" + tempVector.get(randomInt).getBook_id(),
	...
	private void initHealth() {
		...
		vecBook.addAll(MainFImpl.initHealth());
	...
	void setLabelBac(String a, JLabel b) throws IOException {
		...
		img.setImage(img.getImage().getScaledInstance(120, 120,
				Image.SCALE_DEFAULT));

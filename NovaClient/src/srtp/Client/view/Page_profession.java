...
public class Page_profession extends JPanel {
	...
	Page_detail page_1;
	Page_profession ptr;
	public Page_profession() throws IOException {
		...
		booklabel_7.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				//page_1.setBounds(0,200,1100,550); 
				//page_1.setVisible(true);
				//page_1 =new Page_detail(vecClassTwo.get(0).getBook_id(),null);
		...
		booklabel_13.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				//page_1.setBounds(0,380,1100,550);  
				//page_1.setVisible(true);
				//page_1 =new Page_detail(cardNo,vecClassTwo.get(0));
				//page_1 =new Page_detail(vecClassThree.get(0).getBook_id(),null);
		 ...
		 * init academic
		 */
		vecBook.addAll(MainFImpl.initAcademic());
		/**
		 * init class 1;
		 */
		tempVector.clear();
...
//		tempVector.clear();
//		for (int i = 0; i < vecBook.size(); i++) {
//			if (vecBook.get(i).getIntClass() ==4) {
//				tempVector.add(vecBook.get(i));
//			}
//
//		}
...
//		tempVector.clear();
//		for (int i = 0; i < vecBook.size(); i++) {
//			if (vecBook.get(i).getIntClass() ==5) {
//				tempVector.add(vecBook.get(i));
//			}
//
//		}
